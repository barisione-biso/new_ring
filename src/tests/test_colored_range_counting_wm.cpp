...
/*! \file test_colored_range_counting_wm.cpp
    \brief A simple advance test of the CRC WM creation + range search.
...
int main()
{
    ...
    std::cout << " # of Distinct values in full range [1, 11] (second function): " << count << std::endl;
}