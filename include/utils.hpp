...
namespace ring {
    ...
    namespace util {
        ...
        class configuration{
            private:
                enum class execution_mode { sigmod21, one_ring_muthu_leap, one_ring_muthu_leap_adaptive, sigmod21_adaptive, backward_only, backward_only_leap, backward_only_adaptive };
            ...
            public:
                ...
                void configure(std::string &mode, bool print_gao, bool verbose){
                    ...
                    if(m_mode == execution_mode::one_ring_muthu_leap_adaptive || m_mode == execution_mode::sigmod21_adaptive || m_mode == execution_mode::backward_only_adaptive){
                        m_adaptive = true;
                    }
